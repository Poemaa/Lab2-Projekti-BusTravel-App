  ...
  return (
    ...
    <table className='table table-striped' style={{width:'1000px',marginTop:'15px'}}>
      <thead>
        ...
        <th style={{backgroundColor:'#0a4668',color:'white',textAlign:'center', width:"150px",height:'50px'}} scope='col'>Feedback ID</th>
          <th style={{backgroundColor:'#0a4668',color:'white',textAlign:'center',width:"900px"}} scope='col'>Komenti</th> 
            <th style={{backgroundColor:'#0a4668',color:'white',textAlign:'center',width:"200px"}} scope='col'>Emri i Kompanisë</th> 
            <th style={{backgroundColor:'#0a4668',color:'white',textAlign:'center',width:"200px"}} scope='col'>Data</th> 
