...
namespace BusRoute.Migrations
{
    ...
    partial class BusRouteDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusItineraryBusLine", b =>
                {
                    b.Property<int>("BusItinerariesId")
                        .HasColumnType("int");

                    b.Property<int>("BusLinesId")
                        .HasColumnType("int");

                    b.HasKey("BusItinerariesId", "BusLinesId");
            ...
            modelBuilder.Entity("BusItineraryBusLine", b =>
                {
                    b.HasOne("BusRoute.Models.Entities.BusItinerary", null)
                        .WithMany()
                        .HasForeignKey("BusItinerariesId")
